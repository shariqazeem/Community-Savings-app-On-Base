        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950">
            <nav className="border-b border-white/5 backdrop-blur-xl bg-black/30 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        {/* Wallet Component */}
                        <Wallet>
                            <ConnectWallet className="!bg-gradient-to-r !from-emerald-600 !to-emerald-700 hover:!from-emerald-700 hover:!to-emerald-800">
                            ...
                            <WalletDropdown>
                                <Identity
                                    address={address!}
                                    className="!bg-slate-800 !border-white/10 !rounded-2xl"
                                >
                                ...
                                <WalletDropdownDisconnect className="!bg-red-500/10 !text-red-400 hover:!bg-red-500/20" />
                            </WalletDropdown>
                        </Wallet>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
                ...
                <div className="mb-8 sm:mb-12">
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">Welcome back! 👋</h2>
                    <div className="flex items-center gap-3">
                        <Identity address={address!} className="!bg-transparent">
                            <Avatar className="!w-10 !h-10" />
                            <Name className="!text-emerald-400 !font-semibold !text-lg" />
                        </Identity>
                    </div>
                </div>
